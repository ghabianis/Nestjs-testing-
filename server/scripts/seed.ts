...
async function seed(bcryptSalt: Salt) {
  ...
  const queryPolicySelect =
    ...
    "WHERE  policyname = 'Public users are viewable by everyone.' and tablename = User) THEN " +
  ...
  const queryPolicyInsert =
    ...
    "IF NOT EXISTS ( " +
    "SELECT FROM pg_catalog.pg_policies " +
    "WHERE  policyname = 'Users can insert their own users.' and tablename = User) THEN " +
  ...
  const queryPolicyupdate =
    ...
    "IF NOT EXISTS ( " +
    "SELECT FROM pg_catalog.pg_policies " +
    "WHERE  policyname = 'Users can update own users.' and tablename = User) THEN " +
  ...
  const queryPolicySelectId =
    ...
    "IF NOT EXISTS ( " +
    "SELECT FROM pg_catalog.pg_policies " +
    "WHERE  policyname = 'Users are viewable by users who created them.' and tablename = User) THEN " +
